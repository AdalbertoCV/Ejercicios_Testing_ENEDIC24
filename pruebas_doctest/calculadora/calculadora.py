...
class calculadora():
    ...
    def sumar(self, num1,num2):
        # capturamos alguna excepcion por el formato del numero
        try:
            ...
            # Si no se ingresa algun numero, lo indicamos.
    ...
    def restar(self, num1, num2):
        ...
        if isinstance(num1,int) and isinstance(num2,int):
            ...
            # Verificamos que no se envien listas
                ...
                # Si se envia cualquier otro elemento que no sea valido para realizar la operacion.
    ...
    def multiplicar(self, num1, num2):
        ...
        if isinstance(num1,int) and isinstance(num2,int):
            ...
            # Verificamos que no se envien listas
                ...
                # Si se envia cualquier otro elemento que no sea valido para realziar la operacion.
                return 'Elemento no valido para la operacion'
    ...
    def dividir(self, num1, num2):
        ...
        if isinstance(num1,int) and isinstance(num2,int):
            # Verificamos que el divisor no sea un cero, ya que provocaría un error matemático
            if num2>0:
            ...
            # Verificamos que no se envíen listas
                ...
                # Si se envia algun otro elemento que no sea valido para la operacion
                return 'Elemento no valido para la operacion'
    ...
    def sqrt(self,num1,num2):
        ...
        if isinstance(num1,int) and isinstance(num2,int):
            ...
            # Verificamos que no se envien listas.
                ...
                # Si se envia cualquier otro elemento que no sea válido para la operación.
                return 'Elemento no valido para la operacion'
    ...
    def potencia(self,num1,num2):
        ...
        if isinstance(num1,int) and isinstance(num2,int):
            ...
            if num1>0 and num2>0:
                ...
                resultado = num1
                # Iteramos para multipicar el numero, la cantidad de veces indicadas.
