    ...
    def calcular(self, p1, p2, p3):
        ...
        if p1 is not None and p2 is not None and p3 is not None:
            ...
            # Si se han enviado cadenas de texto.
                    ...
                    or isinstance(p3, str):
                return 'No se aceptan cadenas de texto'
            # Si se han enviado listas.
            elif isinstance(p1, list) or isinstance(p2, list) \
                    or isinstance(p3, list):
                return 'No se aceptan listas'
            # Si se envía cualquier otro elemento como tuplas
            # diccionarios, etc.
            else:
